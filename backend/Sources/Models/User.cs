...
public class User
{
    ...
    /// <summary>
    /// The <see cref="Post"/>s liked by this user.
    /// </summary>
    public required ICollection<Post> LikedPosts { get; set; }

    /// <summary>
    /// The <see cref="Post"/>s disliked by this user.
    /// </summary>
    public required ICollection<Post> DislikedPosts { get; set; }
